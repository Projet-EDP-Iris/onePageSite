export const translations = {
  fr: {
    ...
    modal: {
      ...
      subtitle: 'Aidez-nous à améliorer Iris en décrivant le problème rencontré',
      skip: 'Plus tard',
      once: 'Cette fenêtre n\'apparaîtra qu\'une fois',
      loading: 'Chargement…',
      iframeTitle: 'Formulaire de bug',
      email: 'Votre email',
  ...
  en: {
    ...
    modal: {
      title: 'Report a Bug',
      subtitle: 'Help us improve Iris by describing the issue you encountered',
      skip: 'Skip for now',
      once: 'This will only appear once',
      loading: 'Loading...',
      iframeTitle: 'Bug report form',
      email: 'Your email',
      bugTitle: 'Bug title',
      description: 'Description',
